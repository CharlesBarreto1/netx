...
function appEnv(extra = {}) {
  const keys = [
    ...
    'HUAWEI_VOLTAGE_DIVISOR', 'TR069_FEC_HEC_DELTA_ALERT',
    'TR069_DIAGNOSTIC_RETENTION_DAYS', 'TR069_DIAGNOSTIC_MIN_INTERVAL_MIN',
    'TR069_INFORM_RELAX_AFTER_MIN', 'TR069_INFORM_RELAXED_INTERVAL',
    'TR069_PPP_ENABLED', 'TR069_HOSTS_ENABLED', 'TR069_WIFI_MAX_CLIENTS',
    'TR069_SPEEDTEST_URL', 'TR069_SPEEDTEST_UPLOAD_URL', 'TR069_SPEEDTEST_UPLOAD_BYTES',
